    ...
    <div class="goodsBox">
      <div class="goodsBox-img">
        ...
        <div class="goodsBox-btn">
         <br><br>
          <h1>{{goodsInfo.name}}</h1><br>
          <p>{{goodsInfo.desc}}</p><br><br>
    ...
    export default {
        ...
        data() {
          return {
            ...
            goodsInfo: {
              /* 需要展示商品信息 */
              name:'华为 HUAWEI Mate 40 Pro',
              price: '',
              desc: '每一个感动，每一份精彩都不应被遗忘。华为Mate 40 系列，赋予画幅新生，定义探索深远，用超感知影像的力量，让记忆历久弥新，让温暖与美好清晰留存。',
              num: '',
              value: '',
